    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                  websiteId: '3e50fa0d-1291-4bd1-b600-17931b400dfe',
                  name: fullName,
                  email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ניקיונט ניהול פרויקטים בע״מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
